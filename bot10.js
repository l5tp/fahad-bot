...
client.on('messageCreate', async msg => {
    ...
    if (cmd === 'play' || cmd === 'رقصني') {
        ...
        try {
            // بحث دقيق ومستقر 100% في ساوند كلاود بدون أي مشاكل حظر أو تخبيط
            ...
            if (!searchResults || searchResults.length === 0) {
                return searchingMsg.edit('❌ لم يتم العثور على النتيجة، جرب اسم أقصر أو أوضح.');
            }
