...
const CHANNEL_ID = '1545466619638325318';
const TOKEN = process.env.TOKEN_6;
...
client.once('ready', () => { console.log(`[BOT #6] متصل: ${client.user.tag}`); joinVoice(client, state, CHANNEL_ID); });
