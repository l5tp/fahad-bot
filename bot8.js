...
const CHANNEL_ID = '1545466766854197278';
const TOKEN = process.env.TOKEN_8;
...
client.once('ready', () => { console.log(`[BOT #8] متصل: ${client.user.tag}`); joinVoice(client, state, CHANNEL_ID); });
